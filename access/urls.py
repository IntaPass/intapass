...
from access.views import (index, create_access, manage_access, give_access, remove_access, get_status)
...
urlpatterns = [
    ...
    path('manage/<int:pk>/get-status/', get_status, name="get_status"),
